  ...
  if (!product) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center space-y-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-gray-800">{t("product.not_found")}</h1>
        <button 
        ...
        <div className="space-y-10">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500">
              ...
              <span>{t("product.size")}: <span className="font-bold text-black">{product.size}</span></span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-[10px] uppercase font-black tracking-tighter text-stone-400">{t("product.final_price")}</p>
            ...
            {showWarning && (
              <div className="absolute -top-14 left-0 right-0 z-50">
                <div className="bg-yellow-400 text-black text-xs font-black px-6 py-3 rounded-2xl shadow-2xl border border-yellow-500 flex items-center justify-center gap-3 animate-in fade-in slide-in-from-bottom-2">
                  <span className="text-xl">⚠️</span> {t("product.not_active")}
                </div>
              </div>
            )}
            <button 
