    ...
    return (
      <div className="min-h-screen bg-[#FAF7F5] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl p-12 max-w-md w-full text-center shadow-2xl border border-stone-50">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#4A3728] mb-3">Müraciətiniz qəbul edildi!</h2>
          <p className="text-gray-500 text-sm leading-relaxed mb-10">
            Mağazanızın qeydiyyatı üçün müraciətiniz uğurla göndərildi. Komandamız məlumatları yoxladıqdan sonra sizinlə əlaqə saxlayacaq.
          </p>
          <button
      ...
      <section className="bg-[#4A3728] text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Biznesini böyüt, minlərlə müştəriyə çatı və peşəkar satış platformasının imkanlarından yararlan.
          </p>
        </div>
      </section>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-stone-100 flex flex-col md:flex-row gap-10">
            ...
            <div className="shrink-0 flex flex-col items-center space-y-4">
              <div className="w-32 h-32 rounded-2xl bg-[#FAF7F5] border-2 border-dashed border-stone-200 flex flex-col items-center justify-center relative overflow-hidden group cursor-pointer hover:border-[#8E6969] transition">
                {form.logo ? (
                  ...
                  <>
                    ...
                    <span className="text-[10px] text-stone-400 font-bold uppercase tracking-tighter mt-2">Logo Yüklə</span>
                  </>
                )}
                <input 
                  type="file" 
              ...
              <p className="text-[10px] text-gray-400 max-w-[120px] text-center italic">Mağazanızın siması olacaq loqonu əlavə edin.</p>
            </div>
            ...
            <div className="flex-1 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-widest text-[#4A3728]/60 mb-2">Mağaza Adı <span className="text-red-400">*</span></label>
                ...
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-widest text-[#4A3728]/60 mb-2">Fəaliyyət Sahəsi <span className="text-red-400">*</span></label>
                  <select 
                    name="category"
                    value={form.category}
                    onChange={handleChange}
              ...
              <div>
                <label className="block text-[11px] font-bold uppercase tracking-widest text-[#4A3728]/60 mb-2">Mağaza Haqqında <span className="text-red-400">*</span></label>
                <div className="relative">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-stone-100 space-y-6">
            <h2 className="text-lg font-serif font-bold text-[#4A3728] flex items-center gap-2">
              <Globe size={20} className="text-[#8E6969]" /> Əlaqə və İnteqrasiya
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-[11px] font-bold uppercase tracking-widest text-[#4A3728]/60 mb-2">Fiziki Ünvan (Əgər varsa)</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-[11px] font-bold uppercase tracking-widest text-[#4A3728]/60 mb-2">Instagram Hesabı</label>
                <div className="relative">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between p-8 bg-[#8E6969] rounded-2xl shadow-xl text-white">
            <div className="mb-6 md:mb-0">
              <h3 className="text-xl font-serif font-bold mb-1">Mağazanızı təsdiqə göndərin</h3>
              <p className="text-white/70 text-xs max-w-sm">Düzgün məlumatlar mağazanızın daha tez təsdiq olunmasını təmin edəcək.</p>
            </div>
            <button
              type="submit"
            ...
            >
              Mağaza Yarat <ArrowRight size={16} />
            </button>
          </div>
        </form>
      </section>
